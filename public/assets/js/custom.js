(function ($) {
    ...
    if ($('.theme_primaryTable').length) {
        $('.theme_primaryTable').DataTable({
            lengthChange: true,
            "bDestroy": true,
            language: {
    ...
    $(document).ready(function () {
        var table = $('#theme_primaryTable').DataTable({
            lengthChange: true,
            "bDestroy": true,
            language: {
                search: "<i class='ti-search'></i>",
        ...
        table.buttons().container()
            .appendTo('.table_header .table_header_left');
        table.lengthChange().container()
            .appendTo('.table_header_right');
    });
